		<div class="text-center">
			<ul class="pagination pagination-lg">
				<li class="previous pull-left <!-- IF paginate.prev.active -->active<!-- ELSE -->disabled<!-- ENDIF paginate.prev.active -->">
				...
				<li class="next pull-right <!-- IF paginate.next.active -->active<!-- ELSE -->disabled<!-- ENDIF paginate.next.active -->">
