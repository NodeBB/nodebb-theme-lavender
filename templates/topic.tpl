...
<div class="row">
	<div class="topic-container col-lg-9 col-sm-12" no-widget-class="col-lg-12 col-sm-12" no-widget-target="sidebar"> 
		<div class="topic">
	...
	<div widget-area="sidebar" class="col-lg-3 col-sm-12 category-sidebar"></div>
</div><!-- row -->
